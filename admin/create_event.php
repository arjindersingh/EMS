...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_event') {
        ...
        try {
            ...
            header('Location: ' . buildUrl('admin/create_event.php'));
            exit;
...
$eventTypeOptions = ['Conclave','Seminar','Workshop','Conference','Meeting','Competition','Other'];
...
?>
        ...
        <?php if (!empty($adminError ?? '')): ?>
            <div class="alert error"><?php echo htmlspecialchars((string) $adminError, ENT_QUOTES, 'UTF-8'); ?></div>
        <?php endif; ?>

        <?php if (!empty($_SESSION['admin_success'] ?? '')): ?>
            <div class="alert success"><?php echo htmlspecialchars((string) ($_SESSION['admin_success'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></div>
        <?php endif; ?>
        ...
        <form method="post" class="event-form">
            ...
            <div class="form-grid">
                ...
                <div class="form-group checkbox-group full-width">
                    <input id="registration_required" type="checkbox" name="registration_required" value="1" <?php echo !empty($eventFormData['registration_required']) ? 'checked' : ''; ?> />
            ...
            <div class="actions">
                ...
                <?php if (!empty($eventFormData['event_id'])): ?>
                    <a href="<?php echo htmlspecialchars(buildUrl('admin/create_event.php'), ENT_QUOTES, 'UTF-8'); ?>"><button type="button" class="secondary-button">Cancel Edit</button></a>
                <?php endif; ?>
            </div>
        </form>
                ...
                <tbody>
                    <?php foreach ($events as $event): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo htmlspecialchars(buildUrl('admin/create_event.php') . '?edit=' . (int) $event['event_id'], ENT_QUOTES, 'UTF-8'); ?>">Edit</a>
                                |
...
renderAdminLayout('Create Event', $content, ['current_path' => 'create_event', 'page_heading' => 'Create Event']);
