...
<section class="feedback-panel"><h2>Bulk Upload Registrations</h2><p class="small">Upload an Excel file, match its headers to registration fields, provide fixed values where needed, and review the status of every imported row.</p><a class="button-secondary" href="<?php echo htmlspecialchars(buildUrl('admin/registration_bulk_upload.php')); ?>">Open Bulk Upload</a></section>
